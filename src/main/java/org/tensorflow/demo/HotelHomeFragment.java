 ...
 * {@link HotelHomeFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HotelHomeFragment#newInstance} factory method to
...
public class HotelHomeFragment extends Fragment {
     ...
     * @return A new instance of fragment HotelHomeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HotelHomeFragment newInstance(String param1, String param2) {
    ...
    public LinearLayout createAllHotelEntries(ArrayList<Hotel> hotels){
        ...
        for (Hotel hotel : hotels){
            if (hotel.getLicense().equals("Expired")){
