 ...
 * {@link ShopRenewFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ShopRenewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ShopRenewFragment extends Fragment {
     ...
     * @return A new instance of fragment ShopRenewFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ShopRenewFragment newInstance(String param1, String param2) {
        ShopRenewFragment fragment = new ShopRenewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_shop_renew, container, false);
        Bundle bundle = this.getArguments();
        // Inflate the layout for this fragment
        final LayoutInflater inf = inflater;
        final View renewView = inflater.inflate(R.layout.fragment_shop_renew, container, false);

        final Button paymentButton = renewView.findViewById(R.id.shopPaymentButton);
        ...
        final TextView locationValue = renewView.findViewById(R.id.shopValue);
        ...
        final CardView paymentCard = renewView.findViewById(R.id.shopPayment);
        ...
        if(bundle != null){
            ...
            shop = new Shop(id);
            shop = dbHelper.readShop(shop);

            if (shop.getLicense().equals("Valid")){
                paymentCard.setVisibility(View.GONE);
            }
            String[] words = shop.getName().split(" ");
            String name;
            if (words.length > 2){
            ...
            managerValue.setText(shop.getManager());
            phoneValue.setText(shop.getPhone());
            locationValue.setText(shop.getLocation());
            typeValue.setText(shop.getType());
            licenseValue.setText(shop.getLicense());
            setShopImageView(shop,renewView);
            ...
            paymentButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    paymentHotelButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            shop.setLicense("Valid");
                            licenseValue.setText("Valid");
                            paymentCard.setVisibility(View.GONE);
                            dbHelper.updateShopLicense(shop);
                            dialog.dismiss();
                        }
                    });
    ...
    public void setShopImageView(Shop shop, View view){
        Log.e("loading image :",shop.getImagePath());
        Bitmap b = loadImageFromStorage(shop.getImagePath());
        Log.e("Image loaded :",shop.getImagePath());
        ImageView img = view.findViewById(R.id.ShopImageView);
