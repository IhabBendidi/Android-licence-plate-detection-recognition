 ...
 */
public class ShotDetectionActivity extends OneShotCameraActivity implements OnImageAvailableListener {
    ...
    private static final String TOG = "ShotDetectionActivity";
